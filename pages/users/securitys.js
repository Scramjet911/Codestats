...
function Securitys() {
    ...
    return (
        <div>
            ...
            <Navbar />
            <div
                className="container mnav"
                style={{ padding: "3rem", backgroundColor: " rgb(7, 15, 31)" }}
            >
                <div className="row">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="form-group">
                                ...
                                <small
                                    ...
                                    className="form-text ml-4"
                                    style={{
                                        color: "rgba(224, 222, 101, 0.884)",
                                    }}
                                >
                                    Your password must be 8-20 characters, not
                                    containing any spaces.
                                </small>
                                {errors.npassw && (
                                    <span>
                                        <p className="text-danger ml-4 font-weight-light">
